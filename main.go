...
func main() {
	var (
		region  = flag.String("region", "us-west-1", "The region the bucket is in.")
		verbose = flag.Bool("verbose", false, "If we should noisily print items deleted.")
	)
